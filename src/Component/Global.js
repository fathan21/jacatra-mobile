...
export const RenderLoadingBlogDetail = ()=>{
    return (
      <View >
            ...
            <View style={{marginVertical:1,marginHorizontal:5, width:'30%', height:20,backgroundColor:'#e1e4e8'}}>
            </View>
            <View style={{marginVertical:10, width:'100%', height:250,backgroundColor:'#e1e4e8'}}>
            </View>
            
            <View style={{marginVertical:5,marginHorizontal:5, width:'98%', height:20,backgroundColor:'#e1e4e8'}}>
            </View>
            <View style={{marginVertical:5,marginHorizontal:5, width:'98%', height:20,backgroundColor:'#e1e4e8'}}>
            </View>
            <View style={{marginVertical:5,marginHorizontal:5, width:'98%', height:20,backgroundColor:'#e1e4e8'}}>
